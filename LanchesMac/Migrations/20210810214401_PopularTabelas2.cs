...
namespace LanchesMac.Migrations
{
    public partial class PopularTabelas2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoDetalhada,EmEstoque,ImagemThumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) VALUES((SELECT CategoriaId FROM Categorias WHERE CategoriaNome='Natural'),'Pão Integral, queijo branco, atum, cenoura, alface, iogurte','Pão integral natural com queijo branco,atum e cenoura ralada com alface picado e iorgurte natural.',2,'http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg','http://www.macoratti.net/Imagens/lanches/lanchenatural.jpg',0,'Lanche Natural Peito Peru', 15.00)");
        }
